...
export default function Sidebar({ currentUser, activeView, setActiveView }: SidebarProps) {
  ...
  return (
    <aside className="w-68 flex flex-col shrink-0 border-r border-gray-200 bg-slate-900 text-slate-100">
      {/* Brand / Logo Header */}
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className={`text-[10px] ${isActive ? 'text-blue-100' : 'text-slate-400 group-hover:text-slate-300'}`}>
                  {item.description}
                </span>
              </div>
            </button>
