...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        with transaction.atomic():
            ...
            users_data = [
                # SEAMP
                {'id': 'usr-1', 'matricula': '10020-3', 'nome': 'Valdélia Vieira dos Santos Lena', 'cargo': 'Secretária da SEAMP / ACE Sênior', 'codigo_cargo': 'TC/ACE-SENIOR', 'sector': 'SEAMP', 'email': 'vd.lena@tcerr.tc.br', 'role': 'Administrador', 'avatar_url': 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150'},
                {'id': 'usr-2', 'matricula': '20150-1', 'nome': 'Carlos Heider da Silva Souza', 'cargo': 'Auditor de Controle Externo', 'codigo_cargo': 'TC/ACE', 'sector': 'SEAMP', 'email': 'ch.souza@tcerr.tc.br', 'role': 'Auditor', 'avatar_url': 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=150'},
                {'id': 'usr-3', 'matricula': '20155-2', 'nome': 'Renata Vasconcelos de Alencar', 'cargo': 'Auditora de Controle Externo', 'codigo_cargo': 'TC/ACE', 'sector': 'SEAMP', 'email': 'rv.alencar@tcerr.tc.br', 'role': 'Auditor', 'avatar_url': 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150'},
                {'id': 'usr-4', 'matricula': '30040-5', 'nome': 'Marcelo Lima de Castro', 'cargo': 'Coordenador de Monitoramento / ACE', 'codigo_cargo': 'TC/ACE', 'sector': 'SEAMP', 'email': 'ml.castro@tcerr.tc.br', 'role': 'Gestor', 'avatar_url': 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150'},
                # SECGE
                {'id': 'usr-5', 'matricula': '10010-0', 'nome': 'Dr. Roberto Mendes Albuquerque', 'cargo': 'Secretário Geral da SECGE / ACE Executivo', 'codigo_cargo': 'TC/ACE-EXEC', 'sector': 'SECGE', 'email': 'rm.albuquerque@tcerr.tc.br', 'role': 'Administrador', 'avatar_url': 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=150'},
                {'id': 'usr-6', 'matricula': '20240-8', 'nome': 'Patrícia Helena de Souza', 'cargo': 'Auditora de Controle Externo', 'codigo_cargo': 'TC/ACE', 'sector': 'SECGE', 'email': 'ph.souza@tcerr.tc.br', 'role': 'Auditor', 'avatar_url': 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150'},
            ]
            ...
            portarias_data = [
                {
                    ...
                    'supervisor_nome': 'Valdélia Vieira dos Santos Lena', 'supervisor_cargo': 'Secretária de SEAMP', 'supervisor_sector': 'SEAMP',
                ...
                },
                {
                    ...
                    'status': 'Ativa', 'sector': 'SEAMP',
                    'auditor_nome': 'Renata Vasconcelos de Alencar', 'auditor_cargo': 'Auditora de Controle Externo', 'auditor_matricula': '20155-2',
                    'supervisor_nome': 'Valdélia Vieira dos Santos Lena', 'supervisor_cargo': 'Secretária de SEAMP', 'supervisor_sector': 'SEAMP',
            ...
            for p_data in portarias_data:
                ...
                if portaria.id == 'port-016':
                    ...
                    Comentario.objects.create(id='com-1', portaria=portaria, autor='Valdélia Vieira dos Santos Lena', cargo='Secretária de SEAMP', texto='Carlos, favor iniciar o planejamento focando nas cidades mais vulneráveis do norte do Estado: Pacaraima e Amajari.', data_hora='2026-05-05T09:12:00Z')
                    ...
                    Comentario.objects.create(id='com-21-1', portaria=portaria, autor='Renata Vasconcelos de Alencar', cargo='Auditora de Controle Externo', texto='Iniciadas rotas de vistoria aos veículos escolares credenciados.', data_hora='2026-06-10T14:22:00Z')
